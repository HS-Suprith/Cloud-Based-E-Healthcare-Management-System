                        ...
                        <div class="col-md-12">
                            ...
                            <nav id="primary-nav" class="dropdown cf">
                                <ul class="dropdown menu">
                                    ...
                                    <li><a style="color: blue" href="fileRequest.jsp">File Requests</a></li>
                        ...
                        <center>
                            <div class="ex1">
                                <table id="customers">
                                    ...
                                    %>
                                    <tr>
                                        <td class="center"><%=rs.getString("dname")%> </td>
                                        ...
                                        <td><i><a class="btn btn-success btn-fill btn-circle fa fa-check" href="fileApprove.jsp?rid=<%=rs.getString("id")%>">Approve</a></i></td>
                                    </tr>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
